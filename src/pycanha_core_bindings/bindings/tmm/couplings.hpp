...
inline void Coupling_b(nb::module_ &m) {
  nb::class_<Coupling>(m, "Coupling")
      .def(nb::init<Index, Index, double>(), "node_1"_a, "node_2"_a,
           "value"_a)
...
inline void ConductiveCouplings_b(nb::module_ &m) {
  nb::class_<ConductiveCouplings>(
      m, "ConductiveCouplings")
      .def(nb::init<std::shared_ptr<Nodes>>(), "nodes"_a)
      .def("add_coupling",
           nb::overload_cast<Index, Index, double>(&ConductiveCouplings::add_coupling),
           "node_num_1"_a, "node_num_2"_a, "value"_a)
      .def("add_coupling",
           nb::overload_cast<const Coupling &>(&ConductiveCouplings::add_coupling),
           "coupling"_a)
...
inline void RadiativeCouplings_b(nb::module_ &m) {
  nb::class_<RadiativeCouplings>(
      m, "RadiativeCouplings")
      .def(nb::init<std::shared_ptr<Nodes>>(), "nodes"_a)
      .def("add_coupling",
           nb::overload_cast<Index, Index, double>(&RadiativeCouplings::add_coupling),
           "node_num_1"_a, "node_num_2"_a, "value"_a)
      .def("add_coupling",
           nb::overload_cast<const Coupling &>(&RadiativeCouplings::add_coupling),
           "coupling"_a)
