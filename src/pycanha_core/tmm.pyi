...
from .parameters import Formulas, Parameters
...
class ThermalData:
    def __init__(self, network: Optional[ThermalNetwork] = None) -> None: ...
    def associate(self, network: ThermalNetwork) -> None: ...
    def create_new_table(self, name: str, rows: int, cols: int) -> None: ...
    def create_reset_table(self, name: str, rows: int, cols: int) -> None: ...
    ...
    @property
    def network_ptr(self) -> Optional[ThermalNetwork]: ...
    @property
    def size(self) -> int: ...

class ThermalMathematicalModel:
    def __init__(self, model_name: str) -> None: ...
    def add_node(self, node: Node | int) -> None: ...
    def add_conductive_coupling(
        self, node_1: int | Coupling, node_2: Optional[int] = ..., value: float = ...
    ) -> None: ...
    def add_radiative_coupling(
        self, node_1: int | Coupling, node_2: Optional[int] = ..., value: float = ...
    ) -> None: ...
    def callback_solver_loop(self) -> None: ...
    def callback_transient_time_change(self) -> None: ...
    def callback_transient_after_timestep(self) -> None: ...
    @property
    def name(self) -> str: ...
    @name.setter
    ...
    def radiative_couplings(self) -> RadiativeCouplings: ...
    @property
    def thermal_data(self) -> ThermalData: ...
    @property
